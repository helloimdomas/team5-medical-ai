...
def main():
    ...
    parser.add_argument("--captions", default="medgemma_captions_v4.jsonl",
                        help="Path to generated captions JSONL")
    parser.add_argument("--prompt", default="You are a dermatopathologist examining a skin biopsy. This lesion is either MELANOMA or a BENIGN NEVUS. Describe the key histological features in 2-3 sentences, then state your diagnosis (melanoma or benign nevus) and certainty level (high/low).",
